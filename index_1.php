...
<head>
    ...
    <title>Everyday Kibera Netwotk - Recent News</title>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="feature_static_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="assets/img/mama.jpg" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_last_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="assets/img/genz.jpg" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
...
<div class="category_section mobile">
    <div class="article_title">
        <h2><a href="category.html">Political Highlites</a></h2>
    </div>
    <!----article_title------>
            ...
            <div class="col-md-6">
                <div class="top_article_img">
                    <a href="single.html" target="_self"><img class="img-responsive"
                                                               src="assets/img/genz.jpg" alt="feature-top"><P> Photo Gordwin Odhiambo</P>
                    </a>
                </div>
                <!----top_article_img------>
            </div>
...
<div class="category_section tablet">
    <div class="article_title">
        <h2><a href="category.html">Health Highlites</a></h2>
    </div>
    <!-- Mobile News Section -->
...
<div class="category_section gadget">
    <div class="article_title header_black">
        <h2><a href="category.html" target="_self">Sports Highlites</a></h2>
    </div>
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-6">
...
<div class="category_section design">
    <div class="article_title header_blue">
        <h2><a href="category.html" target="_self">Art and Design</a></h2>
    </div>
    <!-- row -->
        ...
        <form action="#" method="post" class="form-horizontal">
            <div class="form-group form-group-lg">
                <label class="col-sm-6 control-label" for="formGroupInputLarge">
                    <h1>Sign up for the latest stories</h1>
                </label>
